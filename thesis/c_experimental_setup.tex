...
% * Figure - View coordinates to the sensor's coordinates.
% * Equation - Noise added to depth image.
% * Equation - Error model from the literature.
% * Figure - Comparison of MABDI error to error model.
...
% As a consequence, when constant noise is added to a point in the
% depth image, it creates noise whose magnitude increases with distance from the sensor for the same point in the sensor's coordinate system.
%
% grows in magnitude as distance from the sensor increases. Luckily,
