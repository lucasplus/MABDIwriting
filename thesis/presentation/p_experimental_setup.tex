...
\begin{frame}{Adding Noise} % __________________________________________________
  ...
  2012, Kourosh Khoshelham and Sander Elberink
  \medskip
  ...
  \end{itemize}}
  \note<2>{\begin{itemize}
    \item We sample a normal distribution and add the value to each pixel
  \end{itemize}}
  \note<3>{\begin{itemize}
...
\item pink points indicate where the
sensor stops along the path.
\item path circles the objects in the environment
twice.
