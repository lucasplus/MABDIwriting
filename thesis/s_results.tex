...
% overview of runs An overview of the experimental runs is given in Fig.
...
% global mesh Fig \ref{fig:gm} shows the resultant global mesh from all of the
runs along with a plot of the number of elements in the mesh over iterations.
