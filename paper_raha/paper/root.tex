...
\author{Lucas Chavez$^{1}$ and Ron Lumia$^{2}$, \textit{Fellow, IEEE}% <-this % stops a space
\thanks{*This work was support in part by Sandia National Laboratories under Purchase Order: 1179196}% <-this % stops a space
