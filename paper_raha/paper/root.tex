...
% \centering
% \includegraphics[width=\textwidth]{figures/run1_dashboard.png}
% \caption{Run 1 results. Static table environment with no noise.}
% \label{fig:run1d}
% \end{figure}
%
% \begin{figure}[hp]%[thpb]
% \centering
% \includegraphics[width=\textwidth]{figures/run3_dashboard.png}
% \caption{Run 1 results. Static table environment with no noise.}
% \label{fig:run1d}
% \end{figure}
